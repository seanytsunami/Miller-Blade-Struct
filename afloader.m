...
%{
    ...
    Purpose: Loads all .csv files from a directory and loads them into a
    ...
    Dependencies:
    - dirloader.m (deals with the files in the directory)

    Notes:
    - afmat has 2 columns per airfoil [chord, lower and upper surfaces]
    - use foilSep.m to extract upper and lower surfaces
...
% tlines = dirloader("Airfoils/Negative");
...
index = 1; % index to allow two row wide loading of matrix
